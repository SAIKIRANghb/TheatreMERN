...
const ScreenUpdateForm = ({ endpoint, initialData, inputTypes, next }) => {
    ...
    return (
        <div className="screen-update-form">
            ...
            <form onSubmit={handleSubmit}>
                ...
                {formData && formData.classInfo.map((cls, index) => (
                    <div key={index}>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        onChange={(e) =>
                            setFormData((prev) => ({ ...prev, selectedSeats: e.target.value.split(', ') }))
                        }
                    />
                </div>
